...
void Graph::addEdge(int u, int v, int weight)
{
    ...
    weight[u].insertItem(weight);
	if(!directed) {
        adjList[v].insertItem(u) ;
        weight[v].insertItem(weight);
    }
}
...
void Graph::removeEdge(int u, int v)
{
    ...
    weight[u].removeItemAt(idx);
    if(!directed) {
        int idx1 = adjList[v].searchItem(u);
        adjList[v].removeItemAt(idx);
        weight[v].removeItemAt(idx);
    }
}
